  ...
  return (
    <div className="relative h-full w-full">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center gap-8 px-6 text-center">
        <h1 className="font-heading text-6xl text-[color:var(--accent)]">
          Evolucija Ajkule
        </h1>
        ...
        <button
          type="button"
          className="rounded-full bg-[color:var(--accent)] px-10 py-4 font-heading text-lg text-slate-900 transition hover:brightness-110"
          onClick={onStart}
        >
          Započni evoluciju
        </button>
